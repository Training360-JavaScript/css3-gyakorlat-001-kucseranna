...
PacmanGame.prototype = {
    ...
    preload: function () {
        ...
        this.load.image('dot', 'js/pacman/assets/dot.png');
        this.load.image('tiles', 'js/pacman/assets/pacman-tiles.png');
        this.load.spritesheet('pacman', 'js/pacman/assets/pacman.png', 32, 32);
        this.load.tilemap('map', 'js/pacman/assets/pacman-map.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    move: function (direction) {
        ...
        console.log(direction, Phaser.UP, Phaser.RIGHT, Phaser.DOWN, Phaser.LEFT);
